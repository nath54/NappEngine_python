...
Traceback (most recent call last):
  ...
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay.py", line 1022, in update_display
    ...
    ~~~~~~~~~~~~~~~~~~~~~^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 1460, in update_display
    scene.render()
    ~~~~~~~~~~~~^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay.py", line 1910, in render
    element.render()
    ~~~~~~~~~~~~~~^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay.py", line 3934, in render
    self.window.enable_area_drawing_constraints(self.x, self.y, self.w, self.h)
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 1412, in enable_area_drawing_constraints
    self._ensure_context()
    ~~~~~~~~~~~~~~~~~~~~^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 570, in _ensure_context
    raise RuntimeError("No current OpenGL program bound.")
RuntimeError: No current OpenGL program bound.
At exit catched
```
...
Is it coherent to check the OpenGL program bound and to raise an error here ?
