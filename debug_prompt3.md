...
Traceback (most recent call last):
  ...
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay.py", line 1022, in update_display
    ...
    ~~~~~~~~~~~~~~~~~~~~~^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 1468, in update_display
    scene.render()
    ~~~~~~~~~~~~^^
  ...
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay.py", line 1992, in render
    ...
    ^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 860, in draw_text
    font_renderer: Optional[FontRenderer] = cast(Optional[FontRenderer], self.display.get_font(font_name, font_size, self))  # type: ignore
                                                                         ~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 381, in get_font
    self.ttf_fonts[font] = FontRenderer(font_path, window)
                           ~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 124, in __init__
    self.load_font(font_path)  # Load font
    ~~~~~~~~~~~~~~^^^^^^^^^^^
  File "/home/nathan/github/NappEngine_python/tests/apps/app1/../../../lib_nadisplay_sdl_opengl3.py", line 216, in load_font
    gl.glVertexAttribPointer(0, 4, gl.GL_FLOAT, gl.GL_FALSE, 0, None)
    ~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
