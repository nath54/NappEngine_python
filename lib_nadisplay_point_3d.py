...
class Collision:
    ...
    def segment_segment(seg1: 'ND_Line_3D', seg2: 'ND_Line_3D') -> tuple[bool, Optional[Union['ND_Point_3D', tuple['ND_Point_3D', 'ND_Point_3D']]]]:
        ...
        ### w0 . v1 ###
        #
        dot_w0_v1 = np.dot(w0, v1)

        #
        ### w0 . v2 ###
        #
        dot_w0_v2 = np.dot(w0, v2)
...
class ND_Rect_3D:
    ...
    def __repr__(self) -> str:
        #
        ### Keep original repr format. ###
        #
        return f"ND_Rect_3D(corner1={self.corner1}, corner2={self.corner2})"
    ...
    def get_intersection_area_with_other_rect(self, other: "ND_Rect_3D") -> Optional["ND_Rect_3D"]:
        ...
        if intersect_min_x > intersect_max_x + EPSILON or \
            ...
            #
            ### No valid intersection rectangle. ###
            #
            return None
...
class ND_Circle_3D:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        ### Allow opposing normals. ###
        #
        return bool( self.center == other.center and abs(self.radius - other.radius) < EPSILON and (np.linalg.norm(self.normal - other.normal) < EPSILON or np.linalg.norm(self.normal + other.normal) < EPSILON) )
...
class ND_Polygon_3D:
    ...
    def __init__(self, vertices: list[ND_Point_3D]) -> None:
        ...
        #
        ### Store calculated normal (TODO) ###
        #
        self.normal: Optional[np.ndarray[Any, Any]] = None
